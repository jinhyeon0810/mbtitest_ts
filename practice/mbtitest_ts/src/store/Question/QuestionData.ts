...
export const QuestionData: IQuestion[] = [
  {
    ...
    answera: "머함? 이름은 뭘로 해주까? 자꾸 말을 걸고 싶다.",
    answerb: "혼자만의 시간이 필요하지? 적응할 시간을 준다",
    type: "EI",
  },
  {
    id: 2,
    title: "고양이에 대한 모든 것이 궁금해졌다. 나의 활동은?",
    answera:
  ...
  },
  {
    ...
    answera:
      "냐옹이 너무 이쁜 것 같아.. 사람들한테 자랑해야지!! 하며 인스타를 만들어 사진도 공유하고 소통도 한다.",
  ...
  {
    id: 6,
    title: "고양이 밥주려고한다. 나의 방법은?",
    answera: "손, 눈대중으로 이정도면 되겠지 하고 급여한다.",
  ...
  },
  {
    ...
    answera:
      "이건 이렇게 하면 어떨까? 해결책을 함께 생각하여 정보들을 찾아본다.",
    answerb: "아이고, 어쩌면 좋아, 일단 먼저 위로를 한다.",
    type: "TF",
  },
  {
    id: 8,
    title: "고양이 키우는데 가족들과 마찰이 생겼다. 이럴땐?",
    answera:
      "나의 생각과 논리가 맞다는 걸 증명하기 위해 가족에게 먼저 설명한다.",
    answerb:
  ...
  },
  {
    ...
    title: "고양이 사료 급여 방법은?",
    answera:
      "우리 고양이는 몸무게가 5키로니까 하루 세번 몇시에 이만큼 주고, 간식은 이때 챙겨줘야겠다. 영양제도 미리미리",
    answerb: "사료 주면 알아서 먹겠지! 일단 자율급식으로 한꺼번에 줘본다.",
    type: "JP",
  },
  {
    id: 11,
